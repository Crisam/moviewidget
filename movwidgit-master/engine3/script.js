...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container3").wowSlider({effect:"basic_linear",prev:"",next:"",duration:40*100,delay:90*100,width:100,height:150,autoPlay:true,playPause:true,stopOnHover:true,loop:false,bullets:0,caption:true,captionEffect:"move",controls:true,onBeforeStep:0,images:0});